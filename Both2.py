"""OPEN BY KALYAN KING  """
#Decode by :- https://t.me/KGF_TERMUX_TEAM
#Tools DC owner :- @Kalyanvai
...
#_____________________[MENU BOX]____________________________#
    def ___file__RanD_All__(self):
        ...
        elif ch in ['4','d','D']:os.system('xdg-open https://t.me/KGF_TERMUX_TEAM');sleep(4);__Main_all_sys___for__run__().__logo__();animation(f'{z}{G}THANKS FOR YOUR FEEDBACK....!');sleep(2);__Main_all_sys___for__run__().__logo__();animation(f'{z}{G}RESTARTING THE TOOL.......!');sleep(0.5);__Main_all_sys___for__run__().___file__RanD_All__()
